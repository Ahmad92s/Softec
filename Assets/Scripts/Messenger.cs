...
static public class Messenger
{
	...
	static public void AddListener<TReturn>(string eventType, Action<TReturn> handler)
	{
		MessengerInternal.AddListener(eventType, handler);
	}
	...
	static public void RemoveListener<TReturn>(string eventType, Action<TReturn> handler)
	{
		MessengerInternal.RemoveListener(eventType, handler);
	}
